...
const HeatmapOverview: React.FC<HeatmapOverviewProps> = ({ disasters, userLocation, nearbyDisasters }) => {
  ...
  return (
    <div className="h-full w-full relative">
      ...
      <div className="absolute bottom-20 right-4 md:bottom-6 md:right-6 z-[2000] pointer-events-none">
        <div className="glass-strong rounded-2xl p-2 md:p-3 border border-white/30 shadow-elevated backdrop-blur-xl pointer-events-auto">
          <EmergencySOS 
